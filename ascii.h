...
string mapicon[19] = { // 19 elements
	...
	"    /              \\                                         /                      \\         .                        8o88o          __       .",
	"   /                \\                                       ;                        ;        .                      o88o           o688o)     .",
	"  /__________________\\                 ;~              - -- |                        | -- -   .'-,    .``'.          _o8o    .-.'-.(6886898o   .",
	"   ||  || /--\\ ||  ||                ./|\\.                  |     _.                 |        .   \\,'`   . \\.  .----| |-.  ,'     o688868698o) .",
	"   ||[]|| | .| ||[]||              ./ /| `\\.                ;    /__`A   ,_          ;        .  .'  /   :   '/          \\'  \\  (68968886)6/88o.",
	" ()||__||_|__|_||__||()           /  | |   `\\.          -'   \\   |= |;._.}{__       /  '-.    . /   '    '   /____________\\   '.  866\\88|889)  .",
	"( )|-|-|-|====|-|-|-|( )         |   | |     `\\.           _.-\"\"-|.' # '. `  `.-\\\"{} < ._     ./    .    \\   | ___   __   | .'  `   (969/9\\    .",
	"^^^^^^^^^^====^^^^^^^^^^^        |    \\|       `\\.               /       \\     \\  x   `\"      .`           _ ||_|_| /  \\  |______     \\//  \\   .",
	"                               .  `----|__________\\.        ----/   OLD   \\_.-'|--X----       .'.`\"'.`,`'./_\\||_|_| | .|  |______\\.`.`||,`,'   .",
	"                                \\-----''----.....___        -=_ | McDonald|    |- X.  =_      .`'^,_`'. ,\"|O||______|  |__|======|,.',|| ,..   .",
	"                                 \\               \"\"/       - __ |_________|_.-'|_X-X##        ..'`. \"\\'^,`.,'.`'``.'/==\\.,.'`,.' `,' .||.,.`   .",
	"                            ~^~^~^~^~^`~^~^`^~^~^`^~^~^        `'-._|_|;:;_.-'` '::.  `\" -    .`',`' `,'.^ '. ,.'`,/====\\,' `,. ^, `.-',, `,   .",
	"                             ~^~^~`~~^~^`~^~^~`~~^~^~        .:; .      .:.   ::.     '::.\"   ..,`^  `. `,`  ,  ,`/======\\,  ,'  `'.,\"     .   ." };
string housemaze[31] = {
